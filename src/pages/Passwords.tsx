      ...
      <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
        <div className="w-full mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate("/")}
              className="cursor-pointer p-1.5 hover:bg-gray-100 rounded-lg transition-colors text-gray-500 hover:text-gray-900"
              title="Go Back"
            >
              <svg
                className="w-5 h-5"
          ...
          <span className="text-xs font-semibold text-gray-400 bg-gray-100 px-2.5 py-1 rounded-full border border-gray-200">
            {sitePassword.length}{" "}
      ...
      <main className="max-w-6xl w-full mx-auto px-4 py-8 flex-1 flex flex-col gap-6">
        {sitePassword.length === 0 ? (
          <div className="flex justify-center w-full">
            <div className="p-12 text-center flex flex-col items-center justify-center bg-white rounded-lg border border-gray-200 shadow-sm w-full max-w-md">
